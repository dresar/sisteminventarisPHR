...
// jika file di include oleh file lain, tampilkan isi file
  ...
  elseif ($_GET['module'] == 'barang' && $_SESSION['hak_akses'] != 'Supervisor') {
  ...
  elseif ($_GET['module'] == 'form_entri_barang' && $_SESSION['hak_akses'] != 'Supervisor') {
  ...
  elseif ($_GET['module'] == 'form_ubah_barang' && $_SESSION['hak_akses'] != 'Supervisor') {
  ...
  elseif ($_GET['module'] == 'tampil_detail_barang' && $_SESSION['hak_akses'] != 'Supervisor') {
  ...
  elseif ($_GET['module'] == 'jenis' && $_SESSION['hak_akses'] != 'Supervisor') {
  ...
  elseif ($_GET['module'] == 'form_entri_jenis' && $_SESSION['hak_akses'] != 'Supervisor') {
  ...
  elseif ($_GET['module'] == 'form_ubah_jenis' && $_SESSION['hak_akses'] != 'Supervisor') {
  ...
  elseif ($_GET['module'] == 'satuan' && $_SESSION['hak_akses'] != 'Supervisor') {
  ...
  elseif ($_GET['module'] == 'form_entri_satuan' && $_SESSION['hak_akses'] != 'Supervisor') {
  ...
  elseif ($_GET['module'] == 'form_ubah_satuan' && $_SESSION['hak_akses'] != 'Supervisor') {
  ...
  elseif ($_GET['module'] == 'barang_masuk' && $_SESSION['hak_akses'] != 'Supervisor') {
  ...
  elseif ($_GET['module'] == 'form_entri_barang_masuk' && $_SESSION['hak_akses'] != 'Supervisor') {
  ...
  elseif ($_GET['module'] == 'barang_keluar' && $_SESSION['hak_akses'] != 'Supervisorg') {
  ...
  elseif ($_GET['module'] == 'form_entri_barang_keluar' && $_SESSION['hak_akses'] != 'Supervisorg') {
