...
// jika user sudah login, tampilkan halaman konten
  ...
  <head>
    ...
    <meta name="description" content="Website inventaris Barang ICT PT pertamina Hulu Rokan Rantau" />
    <meta name="author" content="Code Null" />

    <!-- Title -->
    <title>Website inventaris Barang ICT PT pertamina Hulu Rokan Rantau</title>
...
<a href="?module=dashboard" class="logo">
  <div class="navbar-brand">
    <!-- Ikon Inventaris (misalnya kotak atau barang) -->
    <span><i class="fas fa-box fa-lg text-primary"></i></span> <!-- Ikon Kotak -->
    <span class="text-white">Inventaris</span> <!-- Teks Logo -->
  </div>
</a>
          <!-- Navbar Toggler -->
        ...
        <footer class="footer">
          <div class="container-fluid">
            <div class="copyright ml-auto">
              Copyright &copy; 2025 - <a href="#" class="text-secondary">PT Pertamina Hulu Rokan Rantau</a>.
            </div>
          </div>
        </footer>
        <!-- End Footer -->
