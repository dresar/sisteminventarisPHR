...
CREATE TABLE `tbl_user` (
  ...
  `hak_akses` enum('Administrator','Karyawan ICT','Supervisor') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
UPDATE tbl_user SET divisi = 'ICT' WHERE id_user = 1;
UPDATE tbl_user SET divisi = 'ICT' WHERE id_user = 2;
UPDATE tbl_user SET divisi = 'ICT' WHERE id_user = 3;
...
(2, 'Karyawan ICT', 'Karyawan ICT', '$2y$12$BeRYh13zfPXej97VgcfeNucYJGTElha5sRyIUQm1278D2u2Aqf6DS', 'Karyawan ICT'),
(3, 'Supervisor', 'Supervisor', '$2y$12$odXcPs.RLJJH6Ghv3s42c.5zg5qAOz/S3Adr0lXGNcVSJ6f1hHS6G', 'Supervisor');
...
ALTER TABLE `tbl_barang`
  -- Tambahkan kolom divisi pada tabel tbl_barang
ALTER TABLE tbl_barang ADD COLUMN divisi VARCHAR(50) NOT NULL DEFAULT 'ICT';
